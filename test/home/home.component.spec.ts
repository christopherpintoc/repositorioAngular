...
//import { FiltroPipe } from 'src/app/home/pipes/filtro.pipe';
...
describe('HomeComponent', () => {
  ...
  // let componentPipe: FiltroPipe;
  // let fixturePipe: ComponentFixture<FiltroPipe>;
  ...
  beforeEach(() =>{
    ...
    //let mockPostService = jest.spyOn(['getPost', 'updatePost']);
...
//   beforeEach(async () => {
//     fixturePipe = TestBed.createComponent(FiltroPipe);
//     componentPipe = fixturePipe.componentInstance;
//     fixture.detectChanges();
//   });

//   it('should create pipe', () => {
//     expect(componentPipe).toBeTruthy();
//   });
// });
